                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="text-left py-3 px-4 font-medium text-muted-foreground">Поиск по ID
Мин. сумма
Макс. сумма
Время отвыберите дату
Время довыберите дату</th>
                  ...
                  <tbody>
                    ...
                    return <tr key={deal.id} className="border-b border-border last:border-0 hover:bg-muted/50">
                          ...
                          <td className="py-3 px-4">
                            {(deal.status === "active" || deal.status === "cancelled" || deal.status === "dispute") && <AlertDialog>
